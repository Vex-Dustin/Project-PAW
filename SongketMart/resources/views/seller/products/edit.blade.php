                ...
                <div class="col-md-4">
                    <div class="p-4 bg-white border rounded-4 shadow-sm mb-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="price" class="form-control form-control-lg rounded-3 @error('price') is-invalid @enderror"
                        ...
                        <div class="mb-0">
                            ...
                            <input type="number" name="stock" class="form-control form-control-lg rounded-3 @error('stock') is-invalid @enderror"
