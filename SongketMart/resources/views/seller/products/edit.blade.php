            ...
            <div class="col-md-8">
                <div class="p-4 bg-light rounded-4 border-0">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control form-control-lg rounded-3 @error('name') is-invalid @enderror" value="{{ old('name', $product->name) }}" required>
            ...
            <div class="col-md-4">
                <div class="p-4 bg-white border rounded-4 shadow-sm mb-4">
                    <div class="mb-3">
                        ...
                        <input type="number" name="price" class="form-control form-control-lg rounded-3" value="{{ old('price', $product->price) }}" required>
                    </div>

                    <div class="mb-0">
                        <label class="form-label fw-bold">Stok (Pcs) <span class="text-danger">*</span></label>
                        <input type="number" name="stock" class="form-control form-control-lg rounded-3" value="{{ old('stock', $product->stock) }}" required>
                    </div>
                </div>
                ...
                <div class="p-4 bg-white border rounded-4 shadow-sm text-center">
                    ...
                    @if($product->image)
                    <img src="{{ asset('storage/' . $product->image) }}" class="img-fluid rounded-3 shadow-sm mb-3" style="max-height: 150px; object-fit: cover;">
                    @else
                    ...
                    <div class="text-start">
                        <input type="file" name="image" class="form-control rounded-3 form-control-sm" accept="image/*">
                        <small class="text-muted" style="font-size: 0.7rem;">Abaikan jika tidak ingin mengganti foto.</small>
                    </div>
                </div>
            </div>
