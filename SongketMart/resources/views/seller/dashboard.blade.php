...
@section('seller_content')
    <div class="card border-0 shadow-sm rounded-4 p-3 p-md-4">
            ...
            <div class="row g-2">
                ...
                <div class="col-4">
                    <a href="{{ route('seller.products.index') }}"
                        class="btn btn-white border shadow-sm w-100 py-3 rounded-4 text-dark text-decoration-none h-100">
                ...
                <div class="col-4">
                    <a href="{{ route('seller.orders.index') }}"
                        class="btn btn-white border shadow-sm w-100 py-3 rounded-4 text-dark text-decoration-none position-relative h-100">
                ...
                <div class="p-3 bg-white border rounded-4 shadow-sm h-100">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="fw-bold mb-0">{{ $pending_action ?? 0 }} <span
                                    class="fs-6 fw-normal text-muted">Pesanan</span></h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-3 bg-white border rounded-4 shadow-sm h-100">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 class="fw-bold mb-0">{{ $product_count ?? 0 }} <span
        ...
        <div class="row mt-4 g-3">
            @if (isset($pending_action) && $pending_action > 0)
                <div class="col-12">
                    <div class="p-3 rounded-4 border-0 d-flex align-items-center shadow-sm"
                        style="background-color: #fff4f4; color: #a94442;">
                        <i class="bi bi-info-circle-fill me-3 fs-5"></i>
                        <div class="small">
                            <strong>Info Pesanan:</strong> Ada {{ $pending_action }} pesanan menanti untuk diproses di menu
                            <a href="{{ route('seller.orders.index') }}"
                                class="text-decoration-none fw-bold text-danger">Pesanan Masuk</a>.
                        </div>
                    </div>
                </div>
            @endif
