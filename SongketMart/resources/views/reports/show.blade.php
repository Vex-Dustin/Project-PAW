                ...
                <div class="card-body p-4 pt-0">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            ...
                            <span class="badge bg-secondary-subtle text-secondary small">{{ $report->user->role }}</span>
                        </div>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <form action="{{ route('reports.updateStatus', $report->id) }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-outline-info rounded-pill px-4" {{ $report->status == 'process' ? 'disabled' : '' }}>
